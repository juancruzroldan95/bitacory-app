---
name: Bitacory
description: A therapeutic journaling assistant with an Argentine Spanish AI companion
colors:
  primary: "#288e8e"
  primary-dark: "#45b1b1"
  neutral-bg: "#ffffff"
  neutral-bg-dark: "#404040"
  neutral-text: "#333233"
  neutral-text-dark: "#ececed"
typography:
  display:
...
components:
  ...
  button-primary-hover:
    backgroundColor: "oklch(0.48 0.11 185)"
  card:
