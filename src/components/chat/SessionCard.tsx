...
export const SessionCard = React.memo(function SessionCard({
  ...
  return (
    <article
      onClick={onClick}
      className={`bg-card hover:bg-muted/5 rounded-2xl p-6 shadow-sm hover:shadow-md transition-all duration-300 hover:-translate-y-1 group cursor-pointer border-l-4 border border-y-border border-r-border ${themeDetails.borderLeftClass}`}
    >
      <div className="flex justify-between items-start mb-3">
        <div className={`flex items-center gap-1.5 text-xs font-semibold ${themeDetails.color}`}>
      ...
      <p className="font-serif text-base text-muted-foreground italic pl-3 border-l-2 border-border/60 py-0.5">
